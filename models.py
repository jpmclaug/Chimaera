...
class DeckAnalysis(db.Model):
    """Saved Commander deck analysis generated by Gemini AI with Scryfall metadata."""
    ...
    analysis_json = db.Column(db.Text, nullable=True)  # JSON string of Gemini analysis
    ...
    def to_dict(self, include_full: bool = True):
        """Serializes deck analysis into a dict for JSON API responses."""
        data = {
            "id": self.id,
            "user_id": self.user_id,
